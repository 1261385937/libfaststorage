...
//			 ch::cluster::ch_replica{"192.168.152.134", (uint16_t)9000, "default", "", 2},
//			 ch::cluster::ch_replica{"192.168.152.133", (uint16_t)9000, "default", "", 1}},
//		 6},
//		{std::multiset<ch::cluster::ch_replica>{
//			 ch::cluster::ch_replica{"192.168.152.135", (uint16_t)9000, "default", "", 9},
//			 ch::cluster::ch_replica{"192.168.152.136", (uint16_t)9000, "default", "", 3},
//		 },
//		 4} };
...
//		std::thread([this, &store, &expect_count]() {
...
//	store->reserve_block(batch, 5, 3);
//
//	constexpr size_t expect_count = batch * thread_count;
...
//	{
//		{
//			{ "192.168.152.134", (uint16_t)9000, "default", "", 1 },
//			{ "192.168.152.133", (uint16_t)9000, "default", "", 2 }
//		},
//			6
//	},
//	{
//		{
//			{"192.168.152.135", (uint16_t)9000, "default", "", 3},
//			{"192.168.152.136", (uint16_t)9000, "default", "", 9},
//		},
//		4
//	}
//}));