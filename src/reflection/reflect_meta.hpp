...
struct is_std_unordered_multiset
    : is_sequence_specialization_of<std::unordered_multiset, std::decay_t<T>> {};
...
struct is_std_unordered_map
    : is_associative_specialization_of<std::unordered_map, std::decay_t<T>> {};
...
struct is_std_unordered_multimap
    : is_associative_specialization_of<std::unordered_multimap, std::decay_t<T>> {};
...
template <typename T>
inline constexpr bool is_std_smartptr_v = is_std_sharedptr_v<T> || is_std_uniqueptr_v<T>;

template <typename T>
inline constexpr bool is_sequence_std_container_v =
    is_std_vector_v<T> || is_std_deque_v<T> || is_std_list_v<T> || is_std_forward_list_v<T> ||
    is_std_set_v<T> || is_std_unordered_set_v<T> || is_std_multiset_v<T> ||
    is_std_unordered_multiset_v<T> || is_std_array_v<T>;

template <typename T>
inline constexpr bool is_associative_std_container_v =
    is_std_map_v<T> || is_std_unordered_map_v<T> || is_std_multimap_v<T> ||
    is_std_unordered_multimap_v<T>;

template <typename T>
inline constexpr bool is_std_container_v =
    is_sequence_std_container_v<T> || is_associative_std_container_v<T>;
...
template <typename T>
struct is_has_reflect_type<T, std::enable_if_t<std::is_same_v<typename T::reflect_type, reflect>>>
    : std::true_type {};

template <typename T>
struct is_has_reflect_type<
    T, std::enable_if_t<std::is_same_v<
           typename decltype(reflection_reflect_member(std::declval<T>()))::reflect_type, reflect>>>
    : std::true_type {};

template <typename T>
struct is_has_reflect_type<
    T, std::enable_if_t<is_sequence_std_container_v<T> /*, std::void_t<typename T::value_type>*/>>
    : is_has_reflect_type<typename T::value_type> {};

template <typename T>
struct is_has_reflect_type<
    T,
    std::enable_if_t<is_associative_std_container_v<T> /*, std::void_t<typename T::mapped_type>*/>>
